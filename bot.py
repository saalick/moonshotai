...
OPENAI_API_KEY = "sk-proj-JbOJqgNkW7EVZoJVHzM2T3BlbkFJ1xNXs2semtrgChs3RjoN"
...
def generate(update: Update, context: CallbackContext) -> None:
    ...
    data = {
        ...
        "prompt": f"Generate an image of {text}, if possible try to have a bit content of shiba cat wearing an American flag hat",
        "num_images": 1,
        "size": "1024x1024",
        "quality": "hd",
        "response_format": "url"
